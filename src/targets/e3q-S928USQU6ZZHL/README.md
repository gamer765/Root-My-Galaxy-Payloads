# SM-S928U1 ZZHL experimental Root My Galaxy build
...
- `artifacts/e3q-S928USQU6ZZHL/cve-2026-43499-app.so` — app-domain CVE-2026-43499 payload, built for the ZZHL profile.
...
This is an **experimental, unvalidated** build. It has not been run on ZZHL
hardware. No boot/recovery image is included and nothing here should be
flashed directly.

The exploit profile and P0 table were derived from the patched ZZHL kernel
image. The KernelSU module was compiled against AOSP common `android14-6.1.162`
