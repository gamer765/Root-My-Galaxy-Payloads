...
- `kernelsu/ksud-e3q-S928USQU6ZZHL-kdp-ksun-3.3.0-stock-previous` — the prior stock-late-load daemon retained for rollback.
...
image. The module was compiled against AOSP common `android14-6.1.162`
...
late-load/staging patch. It is 3,748,216 bytes with SHA-256
